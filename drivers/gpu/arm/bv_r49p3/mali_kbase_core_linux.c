...
#include "uapi/gpu/arm/bv_r49p3/mali_kbase_mem_profile_debugfs_buf_size.h"
...
#include <uapi/gpu/arm/bv_r49p3/mali_kbase_ioctl.h>
#if !MALI_USE_CSF
...
#include <linux/mali_drivers/bv_r49p3/mali_hw_access.h>
