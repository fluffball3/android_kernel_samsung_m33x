...
OUT_SIGNEDKERNELZIP="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-noKSU+lindroid_m33x-signed.zip"
OUT_KERNELZIP="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-noKSU+lindroid_m33x.zip"
OUT_KERNELTAR="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-noKSU+lindroid_m33x.tar"
...
# Kernel-side
BUILD_ARGS="LOCALVERSION=-E35P-${E35P_VERSION}-noksu KBUILD_BUILD_USER=fluffyball21 KBUILD_BUILD_HOST=YubiYubi"
