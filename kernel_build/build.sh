...
OUT_SIGNEDKERNELZIP="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-ReSukiSU+SuSFS_m33x-signed.zip"
OUT_KERNELZIP="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-ReSukiSU+SuSFS_m33x.zip"
OUT_KERNELTAR="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-ReSukiSU+SuSFS_m33x.tar"
...
# Kernel-side
BUILD_ARGS="LOCALVERSION=-E35P-${E35P_VERSION}-resus KBUILD_BUILD_USER=fluffyball21 KBUILD_BUILD_HOST=YubiYubi"
