...
export CROSS_COMPILE="$PARENT_DIR/clang-r450784/bin/aarch64-linux-gnu-"
export CC="$PARENT_DIR/clang-r450784/bin/clang"

export PLATFORM_VERSION=12
export ANDROID_MAJOR_VERSION=s
export PATH="$PARENT_DIR/build-tools/path/linux-x86:$PARENT_DIR/clang-r450784/bin:$PATH"
export TARGET_SOC=s5e8825
export LLVM=1 LLVM_IAS=1
export ARCH=arm64

if [ ! -d "$PARENT_DIR/clang-r450784" ]; then
    git clone https://gitlab.com/crdroidandroid/android_prebuilts_clang_host_linux-x86_clang-r450784 "$PARENT_DIR/clang-r450784" --depth=1
fi
