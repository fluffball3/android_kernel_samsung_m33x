...
OUT_SIGNEDKERNELZIP="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-SukiSU-Ultra+SuSFS_m33x-signed.zip"
OUT_KERNELZIP="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-SukiSU-Ultra+SuSFS_m33x.zip"
OUT_KERNELTAR="$(pwd)/kernel_build/Elite3XP-${E35P_VERSION}-SukiSU-Ultra+SuSFS_m33x.tar"
